...
public partial class CreateConeDialog : Window
{
    public ConeCreationParams? Result { get; private set; }

    public CreateConeDialog()
    {
        InitializeComponent();
    }
    ...
    private void OnOk(object sender, RoutedEventArgs e)
    {
            ...
            double.TryParse(HeightBox.Text, out var h) && h > 0)
        {
            ...
            Result = new ConeCreationParams(new Vector3(cx, cy, cz), axis, r, h);
            DialogResult = true;
        }
        else
        {
